...
values
  (1, 'Level 2 bonus: 40 Starburst FR', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'FREE_ROUND', 'net_ent_bonus_code', 1,
   current_timestamp, 2, null, null, null, null, 'EUR'),
  (2, 'Level 5 bonus: 30 Gonzo FR', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'FREE_ROUND', 'net_ent_bonus_code', 1,
   current_timestamp, 2, null, null, null, null, 'EUR'),
  ...
  (4, 'Level 12 bonus: 40 Starburst FR', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'FREE_ROUND', 'net_ent_bonus_code', 1,
   current_timestamp, 2, null, null, null, null, 'EUR'),
  (5, 'Level 15 bonus: 150% dep Bonus', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'DEPOSIT_BONUS', null, 1, current_timestamp, 2,
   null, 120000, null, 150, 'EUR'),
  ...
  (7, 'Level 22 bonus: 30 New Game FR', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'FREE_ROUND', 'net_ent_bonus_code', 1,
   current_timestamp, 2, null, null, null, null, 'EUR'),
  (8, 'Level 25 bonus: 150% dep Bonus', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'DEPOSIT_BONUS', null, 1, current_timestamp, 2,
   null, 120000, null, 150, 'EUR'),
  ...
  (10, 'Level 32 bonus: 150% dep Bonus', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'DEPOSIT_BONUS', null, 1, current_timestamp, 2,
   null, 120000, null, 150, 'EUR'),
  ...
  (13, 'Level 42 bonus: 75€ Free', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'BONUS_MONEY', null, 1, current_timestamp, 2, 7500, null,
   null, null, 'EUR'),
  (14, 'Level 45 bonus: 200% dep Bonus', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'DEPOSIT_BONUS', null, 1, current_timestamp, 2,
   null, 120000, null, 200, 'EUR'),
  (15, 'Level 48 bonus: 100€ Free', timestamp('2013-12-31 23:59:59'), timestamp('2029-12-31 23:59:59'), 'ALL', 'BONUS_MONEY', null, 1, current_timestamp, 2, 10000,
   null, null, null, 'EUR');
